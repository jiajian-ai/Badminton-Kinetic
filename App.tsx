      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pb-20">
        ...
        <section className="mb-12">
          <div className="flex items-center gap-2 mb-4">
            <span className="w-1 h-6 bg-neon-400 rounded-full shadow-[0_0_10px_#ccff00]"></span>
            <h2 className="text-xl font-bold text-white tracking-tight">KINETIC LAB <span className="text-gray-500 text-sm font-normal ml-2">// Interactive Demo</span></h2>
          </div>
